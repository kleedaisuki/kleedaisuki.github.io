---
title: "vibe coding：40 分钟锻造一个标准库气质的 stack"
description: "GPT-5 在接口、类型约束与分配器语义上，确有几分标准库风范。"
date: "2025-08-25"
locale: "zh"
slug: "2025-08-25-1-zh"
tags: ["随性编程", "数据结构"]
draft: false
pair: "2025-08-25-1-en"
---

GPT-5 的工程能力究竟抵达了何处？

不作冗长铺陈，以下是我与它协作 40 分钟后得到的产物。

代码原则上应以 GPLv3.0 发布；但我暂不便建立 GitHub 仓库并提供副本，因此许可证文本请见：<https://www.gnu.org/licenses/>

交互过程中的提示词如下：

```prompt
让我们实现一个 Stack 类，目标标准为 C++23。
...
```prompt
维持设计需求不变（亦即保留既有设计语义约束），继续修复 bug：
[compiler log ...]
```
