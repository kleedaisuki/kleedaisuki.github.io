...
export const ui = {
    en: {
        ...
        "about.github_profile": "Open GitHub Profile",
        "about.stats_followers": "Adherents (Followers)",
        "about.stats_following": "Alliances (Following)",
    ...
    zh: {
        ...
        "about.github_profile": "查看 GitHub 主页",
        "about.stats_followers": "信徒 (Followers)",
        "about.stats_following": "结盟对象 (Following)",
        "about.stats_repos": "咒式仓库 (Repos)",
        "about.repos_title": "近期咒式部署",
